...
//    {
//        assert(obj_idI.size() >= 4 && idI.size() >= 4);
//        obj_idI_ = obj_idI;
//    }
//
//    SHAPEOP_INLINE void OneSideCollisionConstrain::project_in_plane(Matrix3X &obj,
...
//            proj.push_back((pt - origin).dot(axisVec));
//        }
//        return;
//    }
//
...
//        std::vector<Vector3> origin_axis;
//        //objA
